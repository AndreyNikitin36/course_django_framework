...
from adminapp.forms import ShopUserAdminEditForm, ProductCategoryEditForm, ProductCategoryRegisterForm
...
#
#     if request.method == 'POST':
#         categories_form = ProductCategoryRegisterForm(request.POST, request.FILES)
#         if categories_form.is_valid():
#             categories_form.save()
#             return HttpResponseRedirect(reverse('admin:category_create'))
#     else:
#         categories_form = ProductCategoryRegisterForm()
#
#     content = {'title': title, 'update_form': categories_form}
#
...
def products(request, pk):
    ...
    return render(request, 'adminapp/products.html', context=content)
